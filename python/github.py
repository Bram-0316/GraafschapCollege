#make an ai that can play tic tac toe
...
# #make a ai that can play blackjack
...
#     print('<card hidden>')
#     print('', dealer[1])
#     print('\nPlayer\'s Hand:', *player, sep='\n ')


# def show_all(player, dealer):

#     print('\nDealer\'s Hand:', *dealer, sep='\n ')
#     print('Dealer\'s Hand Total:', total(dealer))
#     print('\nPlayer\'s Hand:', *player, sep='\n ')
#     print('Player\'s Hand Total:', total(player))
